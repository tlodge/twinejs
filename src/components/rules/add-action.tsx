...
const actions = [
    ...
    {name: "speech", id: "speech", method:Method.POST, url:"http://[speech]:9106/api/media", params:`("body":("speech":[("words":"a line of speech")]))`, description:"This will send text to the speech synthesizer, or if you render, it will play speech generated Mozilla's speech synthesizer"},
